module gitlab.com/digilab.overheid.nl/ecosystem/ftv/open-ftv/apps/manager
...
require (
	...
	gitlab.com/digilab.overheid.nl/ecosystem/ftv/open-ftv/eam/bundles v0.0.0-20250910102607-d2080e0aa6b2
