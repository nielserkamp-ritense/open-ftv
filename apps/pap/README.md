...
Policies and their metadata can be persisted in a variety of ways.

Policies and metadata are stored in a key-value store.
...
- **in-memory**: using a custom-built Valkeyrie interface.
