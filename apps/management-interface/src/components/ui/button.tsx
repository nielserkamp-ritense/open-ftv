...
const styles = {
    ...
    colors: {
        ...
        secondary: [
            'text-white [--btn-hover-overlay:var(--color-carrotnl-button-primary-action-background-color)]/10 [--btn-border:var(--color-carrotnl-button-primary-action-background-color)]/90',
        ]
    },
}
...
export const SecondaryButton = forwardRef(function Button(
    ...
    return 'href' in props ? (
        ...
        <Headless.Button {...props} className={clsx(classes, 'cursor-default border-1 border-rhc-primary-500 text-carrotnl-button-secondary-action-color hover:bg-carrotnl-button-secondary-action-hover-background-color')} ref={ref}>
            <TouchTarget>{children}</TouchTarget>
        </Headless.Button>
    )
})
