...
type Cerbos struct {
	...
	AdminAddress string `yaml:"cerbos.adminAddress,omitempty" env:"CERBOS_ADMIN" flag:"cerbos-admin" desc:"Address of the Cerbos admin interface"`
	...
	User         string `yaml:"cerbos.adminUser,omitempty" env:"CERBOS_USER" flag:"cerbos-user" desc:"User-id for the Cerbos admin interface"`
	Pswd         string `yaml:"cerbos.adminPassword,omitempty" env:"CERBOS_PSWD" flag:"cerbos-pswd" desc:"Password for the Cerbos admin interface"`
}
