		...
		},
		{
			...
			bundles: map[string]*Config{
				"1": {
					...
					Language: "cedar",
					Tags:     []string{"t1"},
					Targets:  []*Target{{URI: "http://localhost:8080/v1/bundle", APIKey: "abcdef", Encoding: "gzip"}},
				},
			},
		...
		},
		{
			...
			bundles: map[string]*Config{
				"3": {
					...
					Tags:     []string{"t1", "t2"},
					Targets: []*Target{
						{URI: "http://localhost:8080/v1/bundle", APIKey: "abcdef", Encoding: "gzip"},
						{URI: "http://localhost:8081/v1/bundle", APIKey: "abcdef", Encoding: "gzip"},
						{URI: "http://localhost:8082/v1/bundle", APIKey: "abcdef", Encoding: "gzip"},
					},
				},
				"4": {
					Policies: true,
		...
		},
		{
			...
			bundles: map[string]*Config{
				"1": {
					...
					Language: "cedar",
					Tags:     []string{"t1"},
					Targets:  []*Target{{URI: pdp[0].URL, APIKey: "abcdef", Encoding: "gzip"}},
				},
			},
			workers:     2,
			wantLog:     4,
		...
		},
		{
			...
			bundles: map[string]*Config{
				"1": {
					...
					Language: "cedar",
					Tags:     []string{"t1"},
					Targets:  []*Target{{URI: pdp[0].URL, APIKey: "abcdef", Encoding: "bz2"}},
				},
			},
			workers:     2,
			wantLog:     4,
		...
		},
		{
			...
			bundles: map[string]*Config{
				"1": {
					...
					Language: "cedar",
					Tags:     []string{"t1"},
					Targets:  []*Target{{URI: pdp[0].URL, APIKey: "abcdef", Encoding: "oops"}},
				},
			},
			workers:     2,
			wantLog:     4,
		...
		},
		{
			...
			bundles: map[string]*Config{
				"1": {
					...
					Language: "cedar",
					Tags:     []string{"t1"},
					Targets:  []*Target{{URI: pdp[0].URL, APIKey: "wbcdef", Encoding: "gzip"}},
				},
			},
			workers:     2,
			wantErr:     true,
		...
		},
		{
			...
			bundles: map[string]*Config{
				"1": {
					...
					Tags:     []string{"t3"},
					Targets: []*Target{
						{URI: pdp[0].URL, APIKey: "abcdef", Encoding: "gzip"},
						{URI: pdp[1].URL, APIKey: "abcdef", Encoding: "bz1"},
						{URI: pdp[4].URL, APIKey: "abcdef", Encoding: "oops"},
					},
				},
				"2": {
					Policies: true,
					...
					Tags:     []string{"t4"},
					Targets: []*Target{
						{URI: pdp[2].URL, APIKey: "abcdef", Encoding: "bzip2"},
						{URI: pdp[3].URL, APIKey: "abcdef", Encoding: "gz"},
					},
				},
			},
			workers:     2,
