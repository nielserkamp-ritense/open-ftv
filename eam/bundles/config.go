...
type Config struct {
	...
	Title       string    `json:"title"                 yaml:"title"`                 // Unique title for the bundle.
	Description string    `json:"description,omitempty" yaml:"description,omitempty"` // Optional description for the bundle.
