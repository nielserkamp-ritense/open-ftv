...
type AttributeMapping struct {
	...
	IsRequired bool     `json:"required,omitempty"   yaml:"required,omitempty"   toml:"required,omitempty"`   // Flag to indicate the attribute is required, and must **not** be missing from the input.
}
