...
func TestDecodeAttributeMap(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			m:         m1,
			base:      "first",
			obj:       &AttributeMapping{ValueField: "value", IsRequired: true},
			wantCount: 1,
		},
		{
			...
			m:         m1,
			base:      "first",
			obj:       &AttributeMapping{KeyField: "abc", ValueField: "value", IsRequired: true},
			wantCount: 1,
		},
		{
		...
		},
		{
			...
			m:         map[string]any{},
			base:      "first",
			obj:       &AttributeMapping{KeyField: "hello", ValueField: "bool", IsRequired: true},
			wantCount: 1,
		},
		{
			name:      "no value code",
			m:         m1,
			base:      "first",
			obj:       &AttributeMapping{KeyField: "int", IsRequired: true},
			wantCount: 1,
		},
		{
			...
			m:         m1,
			base:      "first",
			obj:       &AttributeMapping{KeyField: "int", ValueField: "oops", IsRequired: true},
			wantCount: 1,
		},
		{
