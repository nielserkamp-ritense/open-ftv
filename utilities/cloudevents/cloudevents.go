...
// CloudEvents 1.0 (https://github.com/cloudevents/spec). It is shared by the
// PIP push-ingest endpoint and the PAP ODRL event endpoints/emitter.
// (Shared copy of eam/pip/cloudevents; keep both in sync until the PIP
// switches over to this package.)
//
