...
func TestFromString(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "duration good (1)", data: "PT25S", t: "http://www.w3.org/2001/XMLSchema#duration", want: 25 * time.Second},
		{name: "duration good (2)", data: "-PT3H17M25.99S", t: "http://www.w3.org/2001/XMLSchema#duration", want: -((3 * time.Hour) + (17 * time.Minute) + (25990 * time.Millisecond))},
		...
		{name: "duration string", data: "P5DT3H", t: "http://www.w3.org/2001/XMLSchema#duration", want: "P5DT3H"},
