...
type Config struct {
	...
	ReadTimeout  time.Duration `yaml:"svc.timeout.read,omitempty" env:"READ_TIMEOUT" flag:"read-timeout" default:"30s" desc:"ReadEntity timeout for API requests"`
...
const (
	AppName   = "FDS Ledenlijst 0.1"
	envPrefix = "FDS_LEDENLIJST_"
	cfg1      = "/etc/fds-leden/default.conf"
	cfg2      = "./etc/fds-leden.yaml"
	cfg3      = "./fds-leden.yaml"
)
