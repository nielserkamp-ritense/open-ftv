...
// func TestTable_CreateRecord(t *testing.T) {
// 	t.Parallel()
//
// 	t.Run("create record", func(t *testing.T) {
// 		t.Parallel()
//
// 		t1 := newTable(&schema.Table{
// 			Object: schema.Object{
// 				Parent:      schema.Parent{ID: "t1"},
// 				Description: "table 1",
// 				Fields: []*schema.Field{
...
// 		require.NotNil(t, t1)
//
// 		t1.CreateRecord(&Row{Data: map[string]any{"f1": "123", "f2": "hello world", "f3": true}})
//
// 	})
// }
