...
func TestAllOfFilter_MatchOnPrimaryData(t *testing.T) {
	t.Parallel()
	...
	testCases := []struct {
		...
		},
		{
			...
			f: AllOfFilter{AllOf: Filters{
				...
				&Filter{FieldValueFilter: FieldValueFilter{Level: enums.PrimaryLevel, Field: "t1.f1", Compare: enums.IsGreater, Value: "1"}},
			}},
			ds:   ds,
		...
		},
		{
			...
			f: AllOfFilter{AllOf: Filters{
				&Filter{FieldValueFilter: FieldValueFilter{Level: enums.PrimaryLevel, Field: "t1.f1", Compare: enums.IsEqual, Value: "1"}},
				&Filter{FieldValueFilter: FieldValueFilter{Level: enums.PrimaryLevel, Field: "f2", Compare: enums.Exists}},
...
func TestAllOfFilter_MatchOnJoinData(t *testing.T) {
	t.Parallel()
	...
	testCases := []struct {
		...
		},
		{
			...
			f: AllOfFilter{AllOf: Filters{
				...
				&Filter{FieldValueFilter: FieldValueFilter{Level: enums.JoinLevel, Join: "j1", Field: "f1", Compare: enums.IsGreater, Value: "1"}},
			}},
			ds:    ds,
			joins: []*schema.Join{j1, j2},
			j:     j1,
		...
		},
		{
			name: "filters do not match",
			f: AllOfFilter{AllOf: Filters{
				&Filter{FieldValueFilter: FieldValueFilter{Level: enums.AnyLevel, Table: "t1", Field: "f1", Compare: enums.IsEqual, Value: "1"}},
				&Filter{FieldValueFilter: FieldValueFilter{Level: enums.JoinLevel, Join: "j1", Field: "f2", Compare: enums.Exists}},
