		...
		},
		{
			...
			field: &Field{
				Object: Object{
					...
					Fields: []*Field{
						{Object: Object{Parent: Parent{ID: "kleur"}, Description: "Kleur"}, Type: enums.StringType},
						{Object: Object{Parent: Parent{ID: "muziek"}, Description: "Muziek"}, Type: enums.StringType},
						{Object: Object{Parent: Parent{ID: "boek"}, Description: "Boek"}, Type: enums.StringType},
					},
				},
				IsPII: true,
			},
...
func TestField_ConvertValue(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "nil", f: &Field{Object: Object{Parent: Parent{ID: "f1"}}, Type: enums.StringType, IsArray: true}},
		{name: "string", f: &Field{Object: Object{Parent: Parent{ID: "f1"}}, Type: enums.StringType}, v: 123456, want: "123456"},
		{name: "email", f: &Field{Object: Object{Parent: Parent{ID: "f1"}}, Type: enums.EmailType}, v: "joep@ftv.us", want: "joep@ftv.us"},
		{name: "integer", f: &Field{Object: Object{Parent: Parent{ID: "f1"}}, Type: enums.IntegerType}, v: "-987654", want: int64(-987654)},
		{name: "unsigned integer", f: &Field{Object: Object{Parent: Parent{ID: "f1"}}, Type: enums.UnsignedIntegerType}, v: "7777777", want: uint64(7777777)},
		{name: "float", f: &Field{Object: Object{Parent: Parent{ID: "f1"}}, Type: enums.FloatType}, v: "12.345678", want: 12.345678},
		{name: "boolean", f: &Field{Object: Object{Parent: Parent{ID: "f1"}}, Type: enums.BooleanType}, v: "true", want: true},
		{name: "date", f: &Field{Object: Object{Parent: Parent{ID: "f1"}}, Type: enums.DateType}, v: "20251012", want: time.Date(2025, 10, 12, 0, 0, 0, 0, time.UTC)},
		{name: "time", f: &Field{Object: Object{Parent: Parent{ID: "f1"}}, Type: enums.TimeType}, v: "15:26:37", want: time.Date(0, 1, 1, 15, 26, 37, 0, time.UTC)},
		{name: "timestamp", f: &Field{Object: Object{Parent: Parent{ID: "f1"}}, Type: enums.DateTimeType}, v: "2025-10-12 15:26:37.999", want: time.Date(2025, 10, 12, 15, 26, 37, 999000000, time.UTC)},
