...
func TestDataspaceFromYAML(t *testing.T) {
	f1 := bytes.NewBufferString(`\000\001`)

	f2 := bytes.NewBufferString(`---
id: "1"
...
func TestDatasourceFromYAML(t *testing.T) {
	f1 := bytes.NewBufferString(`\000\001`)
